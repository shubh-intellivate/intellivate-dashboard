    ...
    setTimeout(function () {
      this.chart_growth_trend = {
          ...
          series: [{
              ...
              data: [622.09,474.48,520.66,2314.92,786.81]
          },{
              name: 'June 2022',
              dataLabels: {
                rotation: 270,
              ...
              data: [590.30,479.04,502.94,1655.86,739.53]
          },{
              name: 'April 2022',
              dataLabels: {
                rotation: 270,
              ...
              data: [522.78,723.98,671.34,1724.51,791.44]
          }]    
      }
    ...
    this.dataService.getOrderOverview(data).subscribe(
      res => {
        if(res.result.status == "true"){
          ...
          Highcharts.chart('chart-gauge-order', this.order_graph_order as any);
          ...
          Highcharts.chart('chart-gauge-order-branch', order_graph_order_single_branch as any);
        }
      }
    );
  }
